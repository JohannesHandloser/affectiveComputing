...
if __name__ == "__main__":
    ph = PipelineHandler()
    list_of_runs = []
    list_of_runs.append(Run(user="punky_2002", test_data_flag="all", type_of_classifier="dummy",  strategy="most_frequent"))
    list_of_runs.append(Run(user="1162656792", test_data_flag="days", type_of_classifier="dummy", strategy="constant"))
